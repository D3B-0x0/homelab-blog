...
3. It gets back: `168.144.74.119` (my VPS's IP)
...
- `blog.debnerd.in. A 168.144.74.119`
...
3. Cloudflare returns:
   - **A record**: `searx.debnerd.in. A 168.144.74.119`
